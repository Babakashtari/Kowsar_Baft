...
<main>
    ...
    <section>
      ...
      <div>
        ...
        <ul>
          <li>
            <p> پارچه های طرح چهارخانه تترون و فاستونی طرح حلزونی</p>
          </li>
          <li>
            <p>
      ...
      <div>
        ...
        <ul>
          <li>
            <p>پارچه های لخت و مقاوم، طرح افکت دار که از قیمت مناسبی تری نسبت به ترگال برخوردار است.</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>عرضه در دو نوع پرشیا مکانیک ساده و پرشیا لنین</p>
          </li>
          <li>
            <p>طاقه های <span class="Yekan">40</span> متری</p>
          </li>
          <li>
            <p>
              رنگ بندی پرشیا مکانیک ساده در کالیته های <span class="Yekan">12</span> رنگی
            </p>
          </li>
          <li>
            <p>
              رنگ بندی پرشیا لنین در کالیته های <span class="Yekan">10</span> رنگی
            </p>
          </li>
