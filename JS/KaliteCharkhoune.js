...
const heightset = () => {
    sectionOne.style.height =
        containers[0].offsetHeight + document.getElementById("radioContainer").offsetHeight + "px";
};
...
const gradients = [
    ...
    // 89
    "url(images/kalite/charkhouneh/new_charkhouneh_blue.png)",
    // 90
    "url(images/kalite/charkhouneh/new_charkhouneh_nafti.png)",
    // 91
    "url(images/kalite/charkhouneh/new_charkhouneh_zereshki.png)"
];
...
(() => {
    const teregal_select = document.querySelectorAll("main>section:nth-of-type(2)>div>select[name='teregal']");
    ...
    const charkhoune_select = document.querySelectorAll('main>section:nth-of-type(2)>div>select[name="Charkhoune"]');
    ...
    const background_select = document.querySelectorAll("main>section:nth-of-type(2)>div>select[name='background']");
...
const colorpicker = event => {
    const charkhouneh_select = document.querySelectorAll('main>section:nth-of-type(2)>div>select[name="Charkhoune"]');
    const T_shirt = document.querySelectorAll("main>section:nth-of-type(2)>div>i");
